/*
 * File Name:	FileSelectionTableViewCell.h
 *
 * Version      1.0.0
 *
 * Date:		06/16/2017
...
@interface FileSelectionTableViewCell : UITableViewCell

@property (strong, nonatomic) IBOutlet UILabel *DateTime;
@property (strong, nonatomic) IBOutlet UILabel *Direction;
@property (strong, nonatomic) IBOutlet UILabel *Jobref;
@property (strong, nonatomic) IBOutlet UILabel *ElevatorName;
